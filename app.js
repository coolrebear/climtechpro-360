...
let language='fr',loadingState='loading',currentAngle=0;
...
loading.textContent=t(loadingState);updateAngle();updateRotationText();try{localStorage.setItem('climtechpro-language',lang);}catch{}}
